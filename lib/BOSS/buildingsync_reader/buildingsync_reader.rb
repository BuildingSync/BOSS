...
module BOSS
  class BuildingSyncReader
    ...
    def get_built_year
      ...
      return year_of_major_remodel if !year_of_major_remodel.nil? && year_of_major_remodel != 0
      ...
      return year_of_construction if !year_of_construction.nil? && year_of_construction != 0
    end
